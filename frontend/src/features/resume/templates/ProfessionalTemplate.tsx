...
export default function ProfessionalTemplate({ content }: TemplateProps) {
  const {
    personalInfo,
    socialLinks,
    skills,
  ...
  const renderSection = (sectionKey: string) => {
    ...
    switch (sectionKey) {
      case 'summary':
        ...
        return (
          <div key="summary" className="pv-resume-section">
            <h2 className="pv-resume-section__title">
              {sectionTitles['summary'] || 'Professional Summary'}
            </h2>
            <div className="pv-resume-section__divider" />
      ...
      case 'skills':
        ...
        return (
          <div key="skills" className="pv-resume-section">
            <h2 className="pv-resume-section__title">
              {sectionTitles['skills'] || 'Skills & Competencies'}
            </h2>
            <div className="pv-resume-section__divider" />
            <div className="pv-resume-skills-list">
              {Object.entries(skillsByCategory).map(([cat, items]) => (
                <div key={cat} className="pv-resume-skill-group">
                  <span className="pv-resume-skill-group__name">
                    {cat.replace(/_/g, ' ').toLowerCase().replace(/\b\w/g, (l) => l.toUpperCase())}:
                  </span>{' '}
                  <span className="pv-resume-skill-group__items">{items.join(', ')}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      case 'experience':
        ...
        return (
          <div key="experience" className="pv-resume-section">
            <h2 className="pv-resume-section__title">
                ...
                <div key={exp.id} className="pv-resume-item">
                  <div className="pv-resume-item__header">
                    <div>
                      ...
                      <span className="pv-resume-item__subtitle"> · {exp.company}</span>
                      {exp.location && <span className="pv-resume-item__loc"> ({exp.location})</span>}
                    </div>
      ...
      case 'projects':
        ...
        return (
          <div key="projects" className="pv-resume-section">
            <h2 className="pv-resume-section__title">
                  ...
                  <div className="pv-resume-item__header">
                    <div>
                      ...
                      {proj.technologies && proj.technologies.length > 0 && (
                        <span className="pv-resume-item__tech">
      ...
      case 'education':
        ...
        return (
          <div key="education" className="pv-resume-section">
            <h2 className="pv-resume-section__title">
            ...
            <div className="pv-resume-items">
              {enabledEducation.map((edu) => (
                <div key={edu.id} className="pv-resume-item">
                  ...
                  {edu.grade && <div className="pv-resume-item__meta">Grade/GPA: {edu.grade}</div>}
      ...
      case 'achievements':
        ...
        return (
          <div key="achievements" className="pv-resume-section">
            <h2 className="pv-resume-section__title">
      ...
      case 'certificates':
        ...
        return (
          <div key="certificates" className="pv-resume-section">
            <h2 className="pv-resume-section__title">
  ...
  return (
    <div className="pv-resume-sheet pv-resume-sheet--professional">
      {/* ── Header / Contact ─────────────────────────────────── */}
      <header className="pv-resume-header pv-resume-header--professional">
