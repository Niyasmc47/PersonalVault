    ...
    <div className="pv-container" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 'var(--sp-48) var(--card-pad)' }}>
      <div className="pv-card" style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <p style={{ marginTop: 'var(--sp-20)', textAlign: 'center', color: 'var(--color-slate-text)' }}>
          Don't have an account? <Link to="/register" style={{ color: 'var(--color-ink-black)', fontWeight: 'var(--weight-medium)' }}>Register here</Link>
        </p>

        <div style={{ marginTop: 'var(--sp-24)', paddingTop: 'var(--sp-24)', borderTop: '1px solid var(--color-mist-divider)' }}>
          <button 
            ...
            style={{ width: '100%', display: 'flex', justifyContent: 'center', gap: 'var(--sp-8)' }}
          >
