      ...
      >
        <div className="pv-modal__header">
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <h2 className="pv-modal__title">Delete Social Link</h2>
          </div>
        ...
        <div style={{ margin: '16px 0 24px 0', fontSize: '14px', lineHeight: 1.5 }}>
          <p>
            Are you sure you want to delete <strong>{link.label}</strong> ({link.url})?
          </p>
          <p style={{ marginTop: '8px', color: 'var(--color-carbon)', opacity: 0.75 }}>
            This action will remove this social profile from your vault.
          </p>
        </div>
